...
class Config(object):
    ...
    CHANNEL_URL = os.environ.get("CHANNEL_URL", "@EdithSeedBox")
    TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "1357340907:AAErbkWEIS2ZthrtRLRsMcy0LgQqdmOKrVQ")
    # The Telegram API things
    APP_ID = int(os.environ.get("APP_ID", 1926237))
    API_HASH = os.environ.get("API_HASH", "2e0063729957c44dfbe0eb6614b296a1")
    OWNER_ID = int(os.environ.get("OWNER_ID", 1478286558))
    # Get these values from my.telegram.org
    # to store the channel ID who are authorized to use the bot
    AUTH_CHANNEL = set(int(x) for x in os.environ.get("AUTH_CHANNEL", "-1001298523491").split())
